...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'graficas', component: GraficasScreenComponent, canActivate: [AuthGuard] },
      { path: 'eventos', component: EventosListComponent, canActivate: [AuthGuard] },
      { path: 'eventos/registrar', component: EventoFormComponent, canActivate: [AuthGuard, AdminGuard] },
      { path: 'eventos/:id/editar', component: EventoFormComponent, canActivate: [AuthGuard, AdminGuard] }
    ]
  },
  // fallback route
